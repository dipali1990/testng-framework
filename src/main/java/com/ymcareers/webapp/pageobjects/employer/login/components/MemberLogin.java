...
/**
 * This class has WebElements for Member login button which is available on Employer dual login
 * Page.
 */
public class MemberLogin extends ComponentValidator {
  ...
  public boolean isDisplayed() {
    wait.until(ExpectedConditions.visibilityOf(memberButton));
    return memberButton.isDisplayed();
  }
}
